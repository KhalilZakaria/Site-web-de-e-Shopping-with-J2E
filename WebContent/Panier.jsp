...
PreparedStatement stmt=con.prepareStatement("select ProduitID,Nom_Produit,Categorie,Prix,image_uri,description,quantite from produits,panier where ProduitID=ProductID and personID=?");
...
<br><br>
		...
		<div >
	<form style="background: #c4d3f6;height:80px" method="post" action='FinaliserPath'>
  <button class='submit-btn' name="Validate" type='submit' style="padding-top:20px;">Finaliser Ma commande</button>
</form>	
		</div>
