        ...
        <div class="container">
            <div class="booking-content">
                ...
                <div class="booking-form">
                    <form id="booking-form" method="post" action="addSuggestionPath">
                        <h2>Vos avis nous intéresse</h2>
                        <div class="form-group form-input">
                         ...
                         <div class="form-group">
                            <div class="select-list">
                                <select name="catP" id="time" required>
                                    <option  value="">Categorie</option>
                                    <option style="color:black; value="FLOUR">FLOUR</option>
                                    <option style="color:black; value="SWEETENERS">SWEETENERS</option>
                                    <option style="color:black; value="FATS">FATS</option>
                                    <option style="color:black; value="LIQUIDS">LIQUIDS</option>
                                    <option style="color:black; value="STUFFING">STUFFING</option>
                        ...
                        <div class="form-group form-input">
                            <input type="text" name="urlP" id="phone" value="" required />
                            <label for="phone" type='text' class="form-label">URL de l'image</label>
                        </div>
                        <div class="form-group form-input">
                            <input type="text" name="descP" id="phone" value="" required />
                            <label for="phone" type='text' class="form-label">Description</label>
                        </div>
                      
                        <div class="form-submit">
                            <input type="submit" value="Envoyer" class="submit" id="submit" name="submit" />
                            <a href="index.jsp" class="vertify-booking">Retour à la page des produits</a>
                        </div>
                    </form>
                </div>
            </div>
